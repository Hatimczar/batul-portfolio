                ...
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2">
                    <a
                      ...
                      className="flex items-center justify-center w-11 h-11 rounded-full border border-[#E8E4DF] text-[#8C7B6B] hover:border-[#C9A96E] hover:text-[#C9A96E] transition-colors duration-300"
                    >
                      <Mail size={18} />
                    </a>
                    <a
